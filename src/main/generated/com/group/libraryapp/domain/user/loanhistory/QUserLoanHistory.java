...
public class QUserLoanHistory extends EntityPathBase<UserLoanHistory> {
    ...
    public final com.group.libraryapp.domain.user.QMember member;
    ...
    public QUserLoanHistory(Class<? extends UserLoanHistory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.group.libraryapp.domain.user.QMember(forProperty("member")) : null;
    }
